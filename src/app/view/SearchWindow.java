...
public class SearchWindow extends JFrame implements CITISObserver {
	...
	private void initGUI() {
		...
		JMenuItem line_table = new JMenuItem("Listado de l�neas");
		...
		JMenu add_obj = new JMenu("A�adir");
		JMenuItem add_station = new JMenuItem("Estaci�n");
		JMenuItem add_transport = new JMenuItem("Transporte");
		JMenuItem add_line = new JMenuItem("L�nea");
		...
		downPanel.setBorder(new TitledBorder("�Qui�nes somos?"));
